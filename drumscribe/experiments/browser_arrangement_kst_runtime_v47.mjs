...
const outDir='drumscribe/experiments/generated-arrangement-kst-v47';
...
for(const song of songs){
  ...
  const row=await page.evaluate(async({song,variants})=>{
    const [
      ...
      import('/drumscribe/transcribe.js?v=arrangement-runtime-v47'),
      import('/drumscribe/arrangement/index.js?v=arrangement-runtime-v47'),
      import('/drumscribe/rhythm-grid.js?v=arrangement-runtime-v47'),
      import('/drumscribe/midi.js?v=arrangement-runtime-v47'),
      import('/drumscribe/meter.js?v=arrangement-runtime-v47'),
    ]);
    const priorResponse=await fetch('/drumscribe/models/gmd-kst/slot-prior-v1.json?v=arrangement-runtime-v47');
