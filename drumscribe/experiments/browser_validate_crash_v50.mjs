...
const variants=['confidence-115','confidence-125','confidence-135'];
const root='drumscribe/experiments/generated-crash-v50';
...
for(const variant of variants){
  ...
  await page.goto('http://127.0.0.1:8000/drumscribe/?cymbalVariant='+encodeURIComponent(variant),
