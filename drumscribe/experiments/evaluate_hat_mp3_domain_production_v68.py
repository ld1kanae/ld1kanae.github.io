...
ROOT=Path('.')
IN=ROOT/'drumscribe/experiments/results-hat-mp3-domain-production-predictions-v68.json'
OUT=ROOT/'drumscribe/experiments/results-hat-mp3-domain-production-v68.json'
MD=ROOT/'drumscribe/experiments/HAT_MP3_DOMAIN_PRODUCTION_V68.md'
...
def main():
    ...
    result={'schema':1,'date':'2026-09-24','experiment':'hat-mp3-domain-production-v68',
    ...
    for variant in ('off','on'):
        ...
        for song in SONGS:
            ...
            row={'song':song,'mp3Info':data['songs'][song][variant].get('mp3Info')}
    ...
    lines=['# MP3-domain Hi-Hat Production Replay v68','',
      'Feature design was established from synchronized WAV/MIDI tail/choke experiments; the final classifier is fitted on repository MP3 candidate distributions after song-held-out model selection. Runtime inputs are audio + generated candidates only.','',
