...
ROOT=Path('.')
IN=ROOT/'drumscribe/experiments/results-hat-sync-candidate-promote-predictions-v67.json'
OUT=ROOT/'drumscribe/experiments/results-hat-sync-candidate-promote-v67.json'
MD=ROOT/'drumscribe/experiments/HAT_SYNC_CANDIDATE_PROMOTE_V67.md'
...
def main():
    ...
    result={'schema':1,'date':'2026-09-24','experiment':'hat-sync-candidate-promote-v67',
    ...
    lines=['# Synchronized Candidate Hi-Hat Promote-Only Replay v67','',
