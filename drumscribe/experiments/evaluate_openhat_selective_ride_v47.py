...
IN=EXP/'results-openhat-selective-ride-predictions-v47.json'
OUT=EXP/'results-openhat-selective-ride-v47.json'
MD=EXP/'OPENHAT_SELECTIVE_RIDE_V47.md'
...
def main():
    ...
    for song in SONGS:
        ...
        for cfg in data['configs']:
            ...
            per[name].append(r)
    report={'schema':1,'date':'2026-09-23','experiment':'openhat-selective-ride-v47',
    ...
    lines=['# Open-hat selective Ride→Open v47','',
      ...
      '|---|---:|---:|---:|---:|---:|---:|']
    for name in ('default','selective70','selective80','selective90'):
    ...
    for name in ('selective70','selective80','selective90'):
