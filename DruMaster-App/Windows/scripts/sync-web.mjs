...
// Windows app-only shell/ranking/performance additions. Keep the shared Web
// and Android builds unchanged.
await Promise.all([
...
console.log('Injected Windows app-only window controls, ranking sync, and performance optimization.');
