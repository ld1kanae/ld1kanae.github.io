...
(()=>{
  ...
  const base={
    pc:{
      normal:{
        title:[70,76,280,58,48,1.05,1,1],artist:[72,145,320,34,24,1.15,1,1],scoreLabel:[72,208,180,28,21,1,7,1],score:[60,236,520,110,92,.9,1,1],summary:[70,348,470,78,16,1.1,1,1],ranking:[600,100,590,390,20,1.1,1,1],retry:[742,550,190,48,15,1.2,1,1],home:[950,550,190,48,15,1.2,1,1]
      },
      auto:{
