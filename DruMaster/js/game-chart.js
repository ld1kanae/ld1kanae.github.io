...
const HH_GRAPH_TYPES=new Set(["hhClosed","hhOpen","hhPedal"]),HH_GRAPH_VELOCITY_CURVE=Math.log(.4)/Math.log(100/127),HH_GRAPH_OPEN_RAMP_BEATS=.25,HH_GRAPH_CLOSE_LEAD_BEATS=.08,HH_GRAPH_CLOSE_RAMP_BEATS=.25;
